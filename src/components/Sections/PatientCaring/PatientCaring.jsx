                ...
                <Grid container spacing={6} alignItems='center'>
                    ...
                    <Grid item xs={12} md={6}>
                        <Typography
                            ...
                            color="primary.main"
                        >
                            HELPING PATIENT FROM AROUND THE GLOBE!
                        </Typography>
                        <Typography variant="h2" mb={1}>
                            Patient <Box component='span' color='primary.main'>Carng</Box>
                        </Typography>
                        <Typography color='#77829D' lineHeight={1.8}>
                            Our goal is to deliver quality of care in a courteous, respectful manner. We hope you will allow us to care for you and strive to be the first and best choice for healthcare.
                        </Typography>
